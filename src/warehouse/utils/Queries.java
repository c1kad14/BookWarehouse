...
public class Queries {
    public static String SELECT_BOOKS = "SELECT Books.Id, Books.Title, Books.Description, Books.Path, Authors.FirstName, Authors.LastName, Genres.Name AS Genre FROM Books INNER JOIN Authors ON Books.AuthorId = Authors.Id "
